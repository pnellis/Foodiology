...
# class Recipe_Ingredients(models.Model):
#     id = models.ForeignKey(Post, to_field = 'id', on_delete = models.CASCADE)
#     ingredient_id = models.ForeignKey(Ingredients, to_field = 'ingredient_id', on_delete = models.CASCADE)
