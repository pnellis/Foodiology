...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    def get_avatar(self):
        if self.avatar:
            return 'https://foodiologyrecipes.com' + self.avatar.url
        # else: 
...
class FriendshipRequest(models.Model): 
    ...
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    created_for = models.ForeignKey(User, related_name='recieved_friendshiprequests', on_delete=models.CASCADE)
