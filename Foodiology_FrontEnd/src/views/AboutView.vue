      ...
      <div class="row">
        ...
        <div class="column">
          <div class="card">
            ...
            <div class="icons">
              ...
              <a href="mailto:page.nellis@emory.edu" target="_blank">
        ...
        <div class="column">
          <div class="card">
            ...
            <div class="icons">
              <a href="https://www.linkedin.com/in/cristinaram?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app"
                target="_blank">
                <i class="fab fa-linkedin"></i>
              </a>
              ...
              <a href="mailto:cristina.ramirez@emory.edu" target="_blank">
                <i class="fas fa-envelope"></i>
              </a>
            </div>
          </div>
        ...
        <div class="column">
          <div class="card">
            ...
            <div class="icons">
              ...
              <a href="mailto:carol.zhou@emory.edu" target="_blank">
                <i class="fas fa-envelope"></i>
              </a>
            </div>
          </div>
        ...
        <div class="column">
          <div class="card">
            ...
            <div class="icons">
              ...
              <a href="mailto:apoon5@emory.edu" target="_blank">
                <i class="fas fa-envelope"></i>
              </a>
            </div>
          </div>
        ...
        <div class="column">
          <div class="card">
            ...
            <div class="icons">
              ...
              <a href="mailto:katie.shao@emory.edu" target="_blank">
                <i class="fas fa-envelope"></i>
              </a>
            </div>
          </div>
...
.card:hover {
  background: linear-gradient(#6bd4d3, #c9f0f0);
  color: #ffffff;
}
