      ...
      <div class="main-right">
        <div class="p-12 bg-white border border-gray-200 rounded-lg">
          <form class="space-y-6" v-on:submit.prevent="submitForm">
            ...
            <div>
              <label class="text-lg font-semibold">E-mail</label><br>
            ...
            <div>
              ...
              <input type="password" v-model="form.password1" placeholder="Your password" class="w-full mt-2 py-3 px-4 border border-pink-600 rounded-lg">
            </div>
  
            <div>
              <label class="text-lg font-semibold">Repeat password</label><br>
              <input type="password" v-model="form.password2" placeholder="Repeat your password" class="w-full mt-2 py-3 px-4 border border-pink-600 rounded-lg">
            </div>
            ...
            <div>
              <button class="py-3 px-4 bg-pink-600 text-white rounded-lg hover:bg-pink-700">Sign up</button>
            </div>
          </form>
        </div>
      </div>
